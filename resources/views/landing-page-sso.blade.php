...
<html lang="en">
<head>
  <title>SSO Kemendikbud Ristek</title>
  <meta charset="UTF-8">
...
<body id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
        ...
        <ul class="navbar-nav align-items-lg-center align-items-start ml-auto">
          <li class="d-flex align-items-center justify-content-between pl-4 pl-lg-0">
            <div class="navbar-collapse-logo">
              <img src="{{ asset('assets/landing-page-sso/images/Group2.svg') }}" alt="">
            </div>
  ...
  <div class="banner" >
    <div class="container">
      <h1 class="font-weight-semibold">Single Login for All Application</h1>
      <h6 class="font-weight-normal text-muted pb-3">Remember Once on Account to Login all Apps</h6>
      <div>
        <button class="btn btn-opacity-light mr-1">Get started</button>
        <a href={{ route('auth-register-basic')}} class="btn btn-opacity-success ml-1">Register Now</a>
      </div>
    ...
    <div class="container">
      <section class="features-overview" id="features-section" >
        <div class="content-header">
          ...
          <h6 class="section-subtitle text-muted">One Account in SSO can Login to All Aplication in Kemendikbud Ristek<br>Don't Need Remember to many account</h6>
        </div>
        <div class="d-md-flex justify-content-between">
          ...
          <div class="grid-margin d-flex justify-content-center">
            <div class="features-width">
              ...
              <h5 class="py-3">Only One<br>Account</h5>
              <p class="text-muted">Lorem ipsum dolor sit amet, tincidunt vestibulum. Fusce egeabus consectetuer turpis, suspendisse.</p>
              <a href="#"><p class="readmore-link">Readmore</p></a>
            </div>
          </div>
          <div class="grid-margin d-flex justify-content-end">
            <div class="features-width">
              ...
              <h5 class="py-3">All User<br>in One Login</h5>
              <p class="text-muted">Lorem ipsum dolor sit amet, tincidunt vestibulum. Fusce egeabus consectetuer turpis, suspendisse.</p>
              <a href="#"><p class="readmore-link">Readmore</p></a>
            </div>
          </div>
      ...
      <section class="digital-marketing-service" id="digital-marketing-section">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-lg-5 p-0 img-digital grid-margin grid-margin-lg-0" data-aos="fade-left">
            <img src="{{ asset('assets/landing-page-sso/images/Group1.png') }}" alt="" class="img-fluid">
          </div>
        </div>
        <div class="row align-items-center">
          <div class="col-12 col-lg-7 text-center flex-item grid-margin" data-aos="fade-right">
            <img src="{{ asset('assets/landing-page-sso/images/Group2.png') }}" alt="" class="img-fluid">
          </div>
      ...
      <section class="case-studies" id="case-studies-section">
        <div class="row grid-margin">
          <div class="col-12 text-center pb-5">
            <h2>Aplication Link with SSO</h2>
              ...
              <div class="card-body p-0">
                <div class="bg-primary text-center card-contents">
                  <div class="card-image">
                    <img src="{{ asset('assets/landing-page-sso/images/Group95.svg') }}" class="case-studies-card-img" alt="">
                  </div>
            ...
            <div class="card color-cards">
              <div class="card-body p-0">
                <div class="bg-violet text-center card-contents">
                  <div class="card-image">
                      <img src="{{ asset('assets/landing-page-sso/images/Group126.svg') }}" class="case-studies-card-img" alt="">
                  </div>
                  <div class="card-desc-box d-flex align-items-center justify-content-around">
                    <div>
            ...
            <div class="card color-cards">
              <div class="card-body p-0">
                <div class="bg-success text-center card-contents">
                  <div class="card-image">
                      <img src="{{ asset('assets/landing-page-sso/images/Group115.svg') }}" class="case-studies-card-img" alt="">
                  </div>
                  <div class="card-desc-box d-flex align-items-center justify-content-around">
                    <div>
        ...
        <div class="row">
          ...
          <div class="owl-carousel owl-theme grid-margin">
              <div class="card customer-cards">
                <div class="card-body">
                  <div class="text-center">
                    <img src="{{ asset('assets/landing-page-sso/images/face2.jpg') }}" width="89" height="89" alt="" class="img-customer">
              ...
              <div class="card customer-cards">
                <div class="card-body">
                  <div class="text-center">
                    <img src="{{ asset('assets/landing-page-sso/images/face3.jpg') }}" width="89" height="89" alt="" class="img-customer">
                    <p class="m-0 py-3 text-muted">Lorem ipsum dolor sit amet, tincidunt vestibulum. Fusce egeabus consectetuer turpis, suspendisse.</p>
                    <div class="content-divider m-auto"></div>
              ...
              <div class="card customer-cards">
                <div class="card-body">
                  <div class="text-center">
                    <img src="{{ asset('assets/landing-page-sso/images/face20.jpg') }}" width="89" height="89" alt="" class="img-customer">
                    <p class="m-0 py-3 text-muted">Lorem ipsum dolor sit amet, tincidunt vestibulum. Fusce egeabus consectetuer turpis, suspendisse.</p>
                    <div class="content-divider m-auto"></div>
              ...
              <div class="card customer-cards">
                <div class="card-body">
                  <div class="text-center">
                    <img src="{{ asset('assets/landing-page-sso/images/face15.jpg') }}" width="89" height="89" alt="" class="img-customer">
                    <p class="m-0 py-3 text-muted">Lorem ipsum dolor sit amet, tincidunt vestibulum. Fusce egeabus consectetuer turpis, suspendisse.</p>
                    <div class="content-divider m-auto"></div>
                    <h6 class="card-title pt-3">Cody Lambert</h6>
                    <h6 class="customer-designation text-muted m-0">Marketing Manager</h6>
              ...
              <div class="card customer-cards">
                <div class="card-body">
                  <div class="text-center">
                    <img src="{{ asset('assets/landing-page-sso/images/face16.jpg') }}" width="89" height="89" alt="" class="img-customer">
                    <p class="m-0 py-3 text-muted">Lorem ipsum dolor sit amet, tincidunt vestibulum. Fusce egeabus consectetuer turpis, suspendisse.</p>
                    <div class="content-divider m-auto"></div>
                    <h6 class="card-title pt-3">Cody Lambert</h6>
                    <h6 class="customer-designation text-muted m-0">Marketing Manager</h6>
              ...
              <div class="card customer-cards">
                <div class="card-body">
                  <div class="text-center">
                    <img src="{{ asset('assets/landing-page-sso/images/face1.jpg') }}" width="89" height="89" alt="" class="img-customer">
                    <p class="m-0 py-3 text-muted">Lorem ipsum dolor sit amet, tincidunt vestibulum. Fusce egeabus consectetuer turpis, suspendisse.</p>
                    <div class="content-divider m-auto"></div>
                    <h6 class="card-title pt-3">Tony Martinez</h6>
                    <h6 class="customer-designation text-muted m-0">Marketing Manager</h6>
      ...
      <section class="contact-details" id="contact-details-section">
        <div class="row text-center text-md-left">
          <div class="col-12 col-md-6 col-lg-3 grid-margin">
            {{-- <img src="{{ asset('assets/landing-page-sso/images/Group2.svg') }}" alt="" class="pb-2"> --}}
            <h4>SSO Kemendikbud Ristek</h4>
            <div class="pt-2">
              <p class="text-muted m-0">email@gmail.com</p>
