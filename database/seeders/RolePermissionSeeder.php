...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $data = array('role_id' => 1,'permissions_id' => 14);	DB::table("role_permissions")->insert($data);
        $data = array('role_id' => 1,'permissions_id' => 15);	DB::table("role_permissions")->insert($data);
        $data = array('role_id' => 1,'permissions_id' => 16);	DB::table("role_permissions")->insert($data);
